...
export const registry = {
  ...
  FrontierTreeDetail: {
    ...
    fields: [
      ...
      { name: 'frontierVoteOutputIdxs', type: { type: 'array', items: 'int' } },
      { name: 'frontierVoteOutputMask', type: 'bytes' },
      { name: 'frontierVoteOutputCount', type: 'int' }, // TODO: bigint?
      { name: 'subtreeOutputCount', type: 'int' },
