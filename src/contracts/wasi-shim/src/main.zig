...
//
// `__heap_base` is a linker-emitted symbol pointing at the first byte after
// the last data segment. Allocating from there avoids clobbering Zig's
// static data (SHA-256 IV constants, format strings, etc.), which Zig
// places at the linker's default `--global-base=1MiB` boundary -- the same
// offset a naïve bump-from-1MB would smash and the next call into
// SHA-256/etc would silently produce wrong output.
...
var bump_ptr: u32 = 0; // populated by reset_bump() on each run
...
export fn run() void {
    ...
    state.init(.{
        ...
        .contract_hash_packed = contract_hash(),
    });
    _start();
...
export fn fd_write(_: i32, _: i32, _: i32, _: i32) i32 { return unsupported.notsup(); }
export fn fd_read(_: i32, _: i32, _: i32, _: i32) i32 { return unsupported.notsup(); }
export fn fd_close(_: i32) i32 { return unsupported.notsup(); }
export fn fd_seek(_: i32, _: i64, _: i32, _: i32) i32 { return unsupported.notsup(); }
export fn fd_tell(_: i32, _: i32) i32 { return unsupported.notsup(); }
export fn fd_fdstat_get(_: i32, _: i32) i32 { return unsupported.notsup(); }
export fn fd_fdstat_set_flags(_: i32, _: i32) i32 { return unsupported.notsup(); }
export fn fd_fdstat_set_rights(_: i32, _: i64, _: i64) i32 { return unsupported.notsup(); }
export fn fd_filestat_get(_: i32, _: i32) i32 { return unsupported.notsup(); }
export fn fd_filestat_set_size(_: i32, _: i64) i32 { return unsupported.notsup(); }
export fn fd_filestat_set_times(_: i32, _: i64, _: i64, _: i32) i32 { return unsupported.notsup(); }
export fn fd_readdir(_: i32, _: i32, _: i32, _: i64, _: i32) i32 { return unsupported.notsup(); }
export fn fd_renumber(_: i32, _: i32) i32 { return unsupported.notsup(); }
export fn fd_sync(_: i32) i32 { return unsupported.notsup(); }
export fn fd_datasync(_: i32) i32 { return unsupported.notsup(); }
export fn fd_advise(_: i32, _: i64, _: i64, _: i32) i32 { return unsupported.notsup(); }
export fn fd_allocate(_: i32, _: i64, _: i64) i32 { return unsupported.notsup(); }
export fn fd_prestat_get(_: i32, _: i32) i32 { return unsupported.notsup(); }
export fn fd_prestat_dir_name(_: i32, _: i32, _: i32) i32 { return unsupported.notsup(); }
export fn fd_pread(_: i32, _: i32, _: i32, _: i64, _: i32) i32 { return unsupported.notsup(); }
export fn fd_pwrite(_: i32, _: i32, _: i32, _: i64, _: i32) i32 { return unsupported.notsup(); }

export fn path_open(_: i32, _: i32, _: i32, _: i32, _: i32, _: i64, _: i64, _: i32, _: i32) i32 {
    return unsupported.notsup();
}
export fn path_filestat_get(_: i32, _: i32, _: i32, _: i32, _: i32) i32 { return unsupported.notsup(); }
export fn path_filestat_set_times(_: i32, _: i32, _: i32, _: i32, _: i64, _: i64, _: i32) i32 { return unsupported.notsup(); }
export fn path_create_directory(_: i32, _: i32, _: i32) i32 { return unsupported.notsup(); }
export fn path_remove_directory(_: i32, _: i32, _: i32) i32 { return unsupported.notsup(); }
export fn path_unlink_file(_: i32, _: i32, _: i32) i32 { return unsupported.notsup(); }
export fn path_rename(_: i32, _: i32, _: i32, _: i32, _: i32, _: i32) i32 { return unsupported.notsup(); }
export fn path_symlink(_: i32, _: i32, _: i32, _: i32, _: i32) i32 { return unsupported.notsup(); }
export fn path_readlink(_: i32, _: i32, _: i32, _: i32, _: i32, _: i32) i32 { return unsupported.notsup(); }
export fn path_link(_: i32, _: i32, _: i32, _: i32, _: i32, _: i32, _: i32) i32 { return unsupported.notsup(); }

export fn poll_oneoff(_: i32, _: i32, _: i32, _: i32) i32 { return unsupported.notsup(); }

export fn sock_recv(_: i32, _: i32, _: i32, _: i32, _: i32, _: i32) i32 { return unsupported.notsup(); }
export fn sock_send(_: i32, _: i32, _: i32, _: i32, _: i32) i32 { return unsupported.notsup(); }
export fn sock_shutdown(_: i32, _: i32) i32 { return unsupported.notsup(); }
