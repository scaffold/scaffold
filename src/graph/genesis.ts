...
import { Atom, AtomBase, AtomType, BlockPayload, BlockRef } from './types.ts';
import { assert } from '../util/functional.ts';
import { AtomSerializerBase } from './AtomSerializer.ts';
import { Ingestor, serializeBlock, UnknownIngestor } from './Ingestor.ts';
...
class GenesisSerializer extends AtomSerializerBase {
