...
export const burnHash = Hash.xor(SBL, Hash.fromLiteralStr('burn'));

export const jackpotHash = Hash.xor(SBL, Hash.fromLiteralStr('jackpot'));

export const frontierHash = Hash.xor(SBL, Hash.fromLiteralStr('frontier'));
