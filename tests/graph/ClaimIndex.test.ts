...
import { AnchorChainNode, ClaimIndex } from '../../src/graph/ClaimIndex.ts';
import { BROKEN_ANCHOR_CHAIN } from '../../src/logic/Forest.ts';
import { Forest } from '../../src/graph/Forest.ts';
import {
  AtomSource,
  AtomType,
  Block,
...
const claimIndex = ctx.get(ClaimIndex);
const forest = ctx.get(Forest);
