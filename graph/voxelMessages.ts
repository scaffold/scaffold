...
const registry = {
  ...
  InputAnswer: {
    ...
    type: 'record',
    fields: [
      { name: 'looking_direction', type: 'Vector2d' },
      ...
      { name: 'pressing_jump', type: 'boolean' },
      { name: 'pressing_use1', type: 'boolean' },
      { name: 'pressing_use2', type: 'boolean' },
      { name: 'chat_msgs', type: { type: 'array', items: 'string' } },
    ],
  },
  PlayerState: {
    name: 'PlayerState',
