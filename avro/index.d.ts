...
declare namespace schema {
  export type AvroSchema = DefinedType | readonly DefinedType[];
...
export function discoverProtocol(
...
export namespace Service {
  ...
  type TransportFunctionCallback = (
  ...
  class Server extends EventEmitter {
    ...
    createChannel(
      transport: Transport,
      options?: Partial<ChannelCreateOptions>,
    ): ServerChannel;
    onMessage<T>(
      name: string,
      handler: (arg1: any, callback: Callback<T>) => void,
    ): this;
    remoteProtocols(): any[];
    use(...args: any[]): this;
  }
