...
| [output-data.md](docs/protocol/output-data.md) | — | — | [Contract.ts](src/contracts/Contract.ts), [RecordingWalkerHost.ts](src/core/RecordingWalkerHost.ts), [Reader.ts](src/interfaces/Reader.ts), [ReaderCursor.ts](src/interfaces/ReaderCursor.ts), [RecordingReader.ts](src/core/RecordingReader.ts) |
