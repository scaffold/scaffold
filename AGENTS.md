...
| [output-data.md](docs/protocol/output-data.md) | — | — | [Contract.ts](src/contracts/Contract.ts), [RecordingWalkerHost.ts](src/core/RecordingWalkerHost.ts), [Reader.ts](src/interfaces/Reader.ts), [RecordingReader.ts](src/core/RecordingReader.ts) |
| [results.md](docs/protocol/results.md) | — | — | [ContractEnv.ts](src/core/ContractEnv.ts) (`setResult`/`getResult`/`fetch`/`put`/`claimNext`/`timestampGte`), [GeneratingEnv.ts](src/core/GeneratingEnv.ts), [VerifyingEnv.ts](src/core/VerifyingEnv.ts), [HashContract.ts](src/contracts/HashContract.ts), [HelloContract.ts](src/contracts/HelloContract.ts) |
...
| [wasm-abi.md](docs/protocol/wasm-abi.md) (`scaffold_builder`/`scaffold_walker`) | [src/contracts/json-wb/](src/contracts/json-wb/) (Zig-built `json-wb.wasm`, generic JSON params/data codec) | — | [Reader.ts](src/interfaces/Reader.ts), [RecordingReader.ts](src/core/RecordingReader.ts), [tests/JsonWb.test.ts](tests/JsonWb.test.ts) |
