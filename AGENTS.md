...
| [wasm-abi.md](docs/protocol/wasm-abi.md) | — (spec only; no implementation yet) | — | [ContractEnv.ts](src/core/ContractEnv.ts), [Contract.ts](src/contracts/Contract.ts), [WorkerChannel.ts](src/worker/WorkerChannel.ts), [Instance.ts](src/worker/Instance.ts), [WasmStore.ts](src/core/WasmStore.ts) |
