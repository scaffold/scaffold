...
| [wire-format.md](docs/protocol/wire-format.md) | — | — | [Atom.ts](src/core/Atom.ts), [Packet.ts](src/core/Packet.ts), [PacketIngestor.ts](src/core/PacketIngestor.ts), [Block.ts](src/core/Block.ts), [BlockSerializer.ts](src/core/BlockSerializer.ts) |
...
| [draft-blocks.md](docs/protocol/draft-blocks.md) | [DraftManager.ts](src/core/DraftManager.ts), [GenerationModule.ts](src/node/GenerationModule.ts) | [GenerationService.ts](src/node/GenerationService.ts) | [BlockDraft.ts](src/core/BlockDraft.ts), [Generator.ts](src/core/Generator.ts) |
