...
MSGSIZE=512; WARMUP=3; DURATION=8
ZIG_PORT=8080; CPP_PORT=8081

OUT_FILE="$BENCH_DIR/results/fanout_$(date +%Y%m%d_%H%M%S).txt"
...
echo "=== fanout (broadcast to all other peers, no dedup) ==="
